...
const Services = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const data = {
        ...
        maxGroupSize: form.maxGroupSize ? parseInt(form.maxGroupSize) : 10,
  ...
  const handleEdit = (service) => {
    ...
    setForm({
      ...
      maxGroupSize: service.maxGroupSize?.toString() || "",
      minAge: service.minAge?.toString() || "",
      difficulty: service.difficulty || "Easy",
            ...
            {filtered.map(service => (
              <div key={service._id} className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-200 overflow-hidden">
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-center text-gray-600 mb-2">
                    <span className="mr-2">👥</span>
                    <span className="text-sm">Max {service.maxGroupSize} people</span>
                  </div>

                  <div className="flex items-center text-gray-600 mb-3">
                    <span className="mr-2">⚡</span>
                    <span className="text-sm capitalize">{service.difficulty}</span>
                  </div>
